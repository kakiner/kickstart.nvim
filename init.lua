...
vim.env.VIMRUNTIME = "/Users/kakiner/nvim-macos-x86_64/share/nvim/runtime/"
...
-- Telescope filebrowser keymaps
vim.keymap.set("n", "<leader>b", ":Telescope file_browser hidden=true path=%:p:h select_buffer=true <CR>")
...
require("lazy").setup({
...

	{
		...
		config = function()
			...
			vim.keymap.set("n", "<leader>gco", ":Git checkout ", { desc = "Git checkout branch" })
...
-- Open init.lua if no other arguments
